...
def eod_position_report(positions, risks, cash_flows, pricing_environment, domain, headers):
    """Return EoD position report.

    positions: basic position report, live positions
    ...
    def construct_report(pos, cfs, rks):
        ...
        for p_id, p in pos.items():
            ...
            re = {
                ...
                'daysInYear': p.get('daysInYear', 365)
            }
            # cash flow
            if p_id in cfs:
                c = cfs[p_id]

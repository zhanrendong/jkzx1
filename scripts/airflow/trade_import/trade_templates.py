...
def asset_generic(direction, underlyer, multiplier, specified_price, init_spot, expiration_date, settlement_date,
                  notional_amount_type,notional, participation_rate, annualized, term, days_in_year, premium_type,
                  premium, front_premium, minimum_premium, effective_date, ann_val_ratio):
    return {
        'direction': direction,
        ...
        'settlementDate': settlement_date.strftime(_date_fmt),
        ...
        'frontPremium': front_premium,
        'minimumPremium': minimum_premium,
        'annValRatio': ann_val_ratio
    }
...
def vanilla_american(trade_id, book, trade_date,
                     ...
                     direction, underlyer, multiplier, specified_price, init_spot, expiration_date, settlement_date,
                     notional_amount_type, notional, participation_rate, annualized, term, days_in_year, premium_type,
                     premium, front_premium, minimum_premium,  effective_date, trader, counter_party, sales,
                     ann_val_ratio):
    asset = asset_generic(direction, underlyer, multiplier, specified_price, init_spot, expiration_date,
                          settlement_date, notional_amount_type, notional, participation_rate, annualized, term,
                          days_in_year, premium_type, premium, front_premium, minimum_premium, effective_date,
                          ann_val_ratio)
    asset.update({
...
# 一触即付
def one_touch(trade_id, book, trade_date, observation_type,
              ...
              premium_type,premium, front_premium, minimum_premium, effective_date, trader, counter_party, sales):
    asset = asset_generic(direction, underlyer, multiplier, specified_price, init_spot, expiration_date,
                          settlement_date, notional_amount_type, notional, participation_rate, annualized, term,
                          days_in_year, premium_type, premium, front_premium, minimum_premium, effective_date)
    asset.update({
...
def double_shark_fin(trade_id, book, trade_date,
                     ...
                     direction, underlyer, multiplier, specified_price, init_spot, expiration_date, settlement_date,
                     notional_amount_type, notional, low_participation_rate, high_participation_rate, annualized, term,
                     days_in_year, premium_type, premium, front_premium, minimum_premium, effective_date, trader,
                     counter_party, sales):
    asset = asset_generic(direction, underlyer, multiplier, specified_price, init_spot, expiration_date,
                          settlement_date, notional_amount_type, notional, 0, annualized, term,
                          days_in_year, premium_type, premium, front_premium, minimum_premium, effective_date)
    ...
    asset.update({
        ...
        'lowStrike': low_strike,
        'highStrike': high_strike,
        'lowParticipationRate': low_participation_rate,
        'highParticipationRate': high_participation_rate,
        'rebateType': rebate_type,
        'rebateUnit': rebate_unit,
...
def eagle(trade_id, book, trade_date,
          ...
          direction, underlyer, multiplier, specified_price, init_spot, expiration_date, settlement_date,
          notional_amount_type, notional, participation_rate1, participation_rate2,  annualized, term, days_in_year,
          premium_type, premium, front_premium, minimum_premium, effective_date, trader, counter_party, sales):
    asset = asset_generic(direction, underlyer, multiplier, specified_price, init_spot, expiration_date,
                          settlement_date, notional_amount_type, notional, participation_rate1, annualized, term,
                          days_in_year, premium_type, premium, front_premium, minimum_premium, effective_date)
    del asset['participationRate']
    asset.update({
        'strikeType': strike_type,
        'participationRate1': participation_rate1,
        'participationRate2': participation_rate2,
        'strike1': strike1,
        'strike2': strike2,
        'strike3': strike3,
        'strike4': strike4
...
def straddle(trade_id, book, trade_date,
             ...
             premium_type, premium, front_premium, minimum_premium, effective_date, trader, counter_party, sales):
    asset = asset_generic(direction, underlyer, multiplier, specified_price, init_spot, expiration_date,
                          settlement_date, notional_amount_type, notional, low_participation_rate, annualized, term,
                          days_in_year, premium_type, premium, front_premium, minimum_premium, effective_date)
    del asset['participationRate']
    asset.update({
        'lowParticipationRate': low_participation_rate,

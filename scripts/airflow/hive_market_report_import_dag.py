...
from utils.airflow_utils import get_valuation_date, get_hive_market_report_start_date
...
dag = DAG(
    'hive_market_report_import_dag',
    catchup=False,
    default_args=default_args,
    schedule_interval='20,21 21 * * *',
    dagrun_timeout=timedelta(hours=1),
    description='import hive market report dag')
# -------------------------------------------------------------------------------

PythonOperator(
    task_id='import_summary_task',
    python_callable=import_summary,
    op_kwargs={'start_date': get_hive_market_report_start_date(), 'end_date': get_valuation_date()},

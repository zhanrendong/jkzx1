...
if __name__ == '__main__':
    ...
    for process in processes.get('children'):
        list = ['BIND_PROCESS_TRIGGER']
        try:
            set_space_auth(process.get('id'),list)
        except Exception as e:
            print(e)

    set_space_auth(processes.get('id'),['CREATE_PROCESS_AND_TRIGGER'])
    ...
    list = ['GRANT_ACTION','CREATE_TRIGGER']
    try:

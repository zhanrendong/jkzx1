...
def create_client_cash_flow(account_id, trade_id, cash_flow, margin_flow):
...
#     create_client_cash_flow(account_id, trade_id, -premium_cash, -margin)
...
if __name__ == '__main__':
    trader = trader_names[0]
    token = utils.login(trader, trader_password, host)
    ...
    book1 = books[0]  # analytic pricer
    book2 = books[1]  # MC pricer

...
@Component
public class VerticalSpreadOptionLCMProcessor implements LCMCompositeProcessor {
    ...
    private VerticalSpreadExerciseProcessor verticalSpreadExerciseProcessor;

    @Autowired
    public VerticalSpreadOptionLCMProcessor(UnwindProcessor unwindProcessor,
                                            ...
                                            VerticalSpreadExerciseProcessor verticalSpreadExerciseProcessor) {
        ...
        this.verticalSpreadExerciseProcessor = verticalSpreadExerciseProcessor;
    }

    @Override
    public List<ProductTypeEnum> productTypes() {
        return Arrays.asList(ProductTypeEnum.VERTICAL_SPREAD);
    }
    ...
    public List<LCMProcessor> processors() {
        return Arrays.asList(
                ...
                verticalSpreadExerciseProcessor);
    }

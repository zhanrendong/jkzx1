...
@Component
public class SpreadsOptionLCMProcessor implements LCMCompositeProcessor {
    ...
    public List<ProductTypeEnum> productTypes() {
        return Arrays.asList(ProductTypeEnum.SPREAD_EUROPEAN, ProductTypeEnum.RATIO_SPREAD_EUROPEAN);
    }

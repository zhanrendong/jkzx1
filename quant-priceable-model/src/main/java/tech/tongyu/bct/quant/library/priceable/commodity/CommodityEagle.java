...
public class CommodityEagle<U extends Commodity & ExchangeListed>
        extends Eagle
    ...
    @JsonCreator
    public CommodityEagle(U underlyer,
    ...
    public List<Position> decompose(String positionId) {
        return decompose().stream()
                .map(p -> new Position(positionId, p._1, new CommodityVanillaEuropean<>(
    ...
    public PriceableTypeEnum getPriceableTypeEnum() {
        return PriceableTypeEnum.COMMODITY_EAGLE;
    }

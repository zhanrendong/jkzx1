...
public class EquityKnockOutContinuous<U extends Equity & ExchangeListed>
        extends KnockOutContinuous
        implements Equity, Priceable, HasUnderlyer {
    @JsonTypeInfo(use = JsonTypeInfo.Id.CLASS)
    private final U underlyer;

    public EquityKnockOutContinuous(U underlyer, LocalDateTime expiry, double strike, OptionTypeEnum optionType,
    ...
    public PriceableTypeEnum getPriceableTypeEnum() {
        return PriceableTypeEnum.EQUITY_KNOCK_OUT_CONTINUOUS;
    }

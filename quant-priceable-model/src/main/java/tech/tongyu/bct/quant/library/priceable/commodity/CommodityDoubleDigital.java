...
public class CommodityDoubleDigital <U extends Commodity & ExchangeListed>
    ...
    public CommodityDoubleDigital(U underlyer, OptionTypeEnum optionTypeEnum, LocalDateTime expiry, double firstStrike, double firstPayment, double secondStrike, double secondPayment) {
    ...
    public PriceableTypeEnum getPriceableTypeEnum() {
        return PriceableTypeEnum.COMMODITY_DOUBLE_DIGITAL;
    }

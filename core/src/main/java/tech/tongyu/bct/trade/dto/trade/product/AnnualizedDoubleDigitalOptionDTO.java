...
public class AnnualizedDoubleDigitalOptionDTO {
    ...
    public BigDecimal lowPayment;
    public BigDecimal highPayment;
    ...
    public AnnualizedDoubleDigitalOptionDTO(InstrumentOfValuePartyRoleTypeEnum direction, BusinessCenterTimeTypeEnum specifiedPrice,
                                            ...
                                            UnitEnum paymentType, BigDecimal lowPayment, BigDecimal highPayment,

...
public class AnnualizedRangeAccrualsOptionDTO {
    ...
    @BctField(description = "障碍类型",componentClass = UnitEnum.class)
    ...
    public AnnualizedRangeAccrualsOptionDTO(InstrumentOfValuePartyRoleTypeEnum direction, BusinessCenterTimeTypeEnum specifiedPrice,
                                            ...
                                            LocalDate effectiveDate, LocalDate expirationDate, UnitEnum barrierType,
                                            BigDecimal lowBarrier, BigDecimal highBarrier, UnitEnum paymentType,
                                            BigDecimal payment, Map<LocalDate, BigDecimal> fixingObservations,

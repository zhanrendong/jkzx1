...
public class AnnualizedAutoCallOptionDTO {
    ...
    @BctField(description = "逐步调整步长（%）", componentClass = BigDecimal.class)
    public BigDecimal step;
    @BctField(description = "敲出观察频率")
    ...
    public UnitEnum autoCallStrikeUnit;
    @BctField(description = "到期未敲出行权价格", componentClass = BigDecimal.class)
    public BigDecimal autoCallStrike;
    @BctField(description = "到期未敲出固定收益", componentClass = BigDecimal.class)
    ...
    public AnnualizedAutoCallOptionDTO(InstrumentOfValuePartyRoleTypeEnum direction, BusinessCenterTimeTypeEnum specifiedPrice,
                                       ...
                                       LocalDate effectiveDate, LocalDate expirationDate, Map<LocalDate, BigDecimal> fixingObservations,
                                       Map<LocalDate, LocalDate> fixingPaymentDates, Map<LocalDate, BigDecimal> observationBarriers,
                                       KnockDirectionEnum knockDirection, UnitEnum barrierType, BigDecimal barrier,
                                       BigDecimal step, String knockOutObservationStep, BigDecimal couponPayment,
                                       AutoCallPaymentTypeEnum autoCallPaymentType, UnitEnum autoCallStrikeUnit,
                                       BigDecimal autoCallStrike, BigDecimal fixedPayment, BigDecimal annualizedActualNotionalAmount,
        ...
        this.autoCallStrikeUnit = autoCallStrikeUnit;

...
import tech.tongyu.bct.cm.product.iov.BarrierObservationTypeEnum;
...
public class AnnualizedDigitalOptionDTO {
    ...
    public UnitEnum rebateUnit;

    @BctField(description = "年化系数", componentClass = BigDecimal.class)
    public BigDecimal annValRatio;

    public AnnualizedDigitalOptionDTO() {
    }

    public AnnualizedDigitalOptionDTO(InstrumentOfValuePartyRoleTypeEnum direction, BusinessCenterTimeTypeEnum specifiedPrice,
                                      ExerciseTypeEnum exerciseType, String underlyerInstrumentId, OptionTypeEnum optionType,
                                      String counterpartyCode, BigDecimal underlyerMultiplier, BigDecimal participationRate,
                                      ...
                                      LocalDate effectiveDate, LocalDate expirationDate, UnitEnum strikeType, BigDecimal strike,
                                      BarrierObservationTypeEnum observationType, RebateTypeEnum rebateType, UnitEnum paymentType, BigDecimal payment,
                                      ...
                                      BigDecimal rebate, UnitEnum rebateUnit, BigDecimal annValRatio) {

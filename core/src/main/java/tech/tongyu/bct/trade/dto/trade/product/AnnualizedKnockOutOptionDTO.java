...
public class AnnualizedKnockOutOptionDTO {
    ...
    public BigDecimal barrierShift;
    ...
    public AnnualizedKnockOutOptionDTO() {
    }

    public AnnualizedKnockOutOptionDTO(InstrumentOfValuePartyRoleTypeEnum direction, BusinessCenterTimeTypeEnum specifiedPrice,
                                       ...
                                       UnitEnum strikeType, BigDecimal strike, BarrierObservationTypeEnum observationType,
                                       KnockDirectionEnum knockDirection, UnitEnum barrierType, BigDecimal barrier,
                                       BigDecimal barrierShift, String knockOutObservationStep,
                                       Map<LocalDate, BigDecimal> fixingObservations, RebateTypeEnum rebateType,
                                       UnitEnum rebateUnit, BigDecimal rebate

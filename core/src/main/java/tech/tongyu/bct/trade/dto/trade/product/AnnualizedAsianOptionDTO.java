...
public class AnnualizedAsianOptionDTO {
    ...
    @BctField(description = "名义本金数量", componentClass = BigDecimal.class)
    ...
    @BctField(description = "观察频率")
    public String observationStep;
    @BctField(description = "观察权重")
    ...
    public AnnualizedAsianOptionDTO(InstrumentOfValuePartyRoleTypeEnum direction, BusinessCenterTimeTypeEnum specifiedPrice,
                                    ...
                                    String observationStep, Map<LocalDate, BigDecimal> fixingWeights,
                                    Map<LocalDate, BigDecimal> fixingObservations, BigDecimal annualizedActualNotionalAmount,

...
import tech.tongyu.bct.cm.product.iov.KnockEnum;
...
public class AnnualizedDoubleSharkFinOptionDTO {
    ...
    public BigDecimal lowRebate;
    public BigDecimal highRebate;
    ...
    public AnnualizedDoubleSharkFinOptionDTO() {
    }

    public AnnualizedDoubleSharkFinOptionDTO(InstrumentOfValuePartyRoleTypeEnum direction, BusinessCenterTimeTypeEnum specifiedPrice,
                                             ...
                                             LocalDate effectiveDate, LocalDate expirationDate, BarrierObservationTypeEnum observationType,
                                             ...
                                             RebateTypeEnum rebateType, UnitEnum rebateUnit, BigDecimal lowRebate,
                                             BigDecimal highRebate, BigDecimal annualizedActualNotionalAmount,

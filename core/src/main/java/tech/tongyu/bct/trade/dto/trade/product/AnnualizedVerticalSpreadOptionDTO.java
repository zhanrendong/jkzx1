...
public class AnnualizedVerticalSpreadOptionDTO {
    ...
    public AnnualizedVerticalSpreadOptionDTO() {
    }

    public AnnualizedVerticalSpreadOptionDTO(ExerciseTypeEnum exerciseType, InstrumentOfValuePartyRoleTypeEnum direction,
                                             String underlyerInstrumentId, BigDecimal initialSpot, UnitEnum trikeType,
                                             BigDecimal lowStrike, BigDecimal highStrike,
                                             ...
                                             UnitEnum premiumType, BigDecimal frontPremium,

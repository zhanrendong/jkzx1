...
public class AnnualizedVerticalSpreadOption<U extends InstrumentOfValue> implements InstrumentOfValue, OptionExerciseFeature,
        InitialSpotFeature, PremiumFeature, ParticipationRateFeature, SettlementFeature, EffectiveDateFeature, MultipleStrikeFeature {
    public AnnualizedVerticalSpreadOption() {

    }

    public AnnualizedVerticalSpreadOption(U underlyer, BigDecimal underlyerMultiplier, OptionTypeEnum optionType, ProductTypeEnum productType,
                                          InstrumentAssetClassTypeEnum assetClassType, UnitOfValue<BigDecimal> notionalAmount,
                                          BigDecimal participationRate, LocalDate startDate,
                                          LocalDate endDate, BigDecimal daysInYear, BigDecimal term, Boolean annualized,
                                          ExerciseTypeEnum exerciseType, AdjustedDate expirationDate, LocalTime expirationTime,
                                          BigDecimal initialSpot, LocalDate settlementDate, SettlementTypeEnum settlementType, List<UnitOfValue<BigDecimal>> strikes,
                                          LocalDate effectiveDate, BusinessCenterTimeTypeEnum specifiedPrice, UnitOfValue<BigDecimal> frontPremium, UnitOfValue<BigDecimal> minimumPremium,
                                          UnitOfValue<BigDecimal> premium, BigDecimal annValRatio) {
    ...
    public String instrumentId() {
        return String.format("Vertical_%s_option_European_%s",
    ...
    public List<UnitOfValue<BigDecimal>> strikes;

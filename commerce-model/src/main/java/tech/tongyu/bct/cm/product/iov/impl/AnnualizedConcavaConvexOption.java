...
public class AnnualizedConcavaConvexOption<U extends InstrumentOfValue> implements InstrumentOfValue, OptionExerciseFeature,
        InitialSpotFeature, PremiumFeature, SettlementFeature, EffectiveDateFeature, DoubleBarrierFeature, PaymentFeature{

    public AnnualizedConcavaConvexOption() {
    }

    public AnnualizedConcavaConvexOption(U underlyer, ProductTypeEnum productType, InstrumentAssetClassTypeEnum assetClassType,
                                         ...
                                         LocalTime expirationTime, Boolean concavaed, UnitOfValue<BigDecimal> lowBarrier,
                                         UnitOfValue<BigDecimal> highBarrier, UnitOfValue<BigDecimal> payment,
    ...
    public String instrumentId() {
        return String.format("ConcavaConvex_European_%s",

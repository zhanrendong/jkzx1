...
public class AnnualizedVanillaOption<U extends InstrumentOfValue> implements InstrumentOfValue, OptionExerciseFeature,
        InitialSpotFeature, PremiumFeature, ParticipationRateFeature, SettlementFeature, EffectiveDateFeature, SingleStrikeFeature {
    public AnnualizedVanillaOption() {

    }

    public AnnualizedVanillaOption(U underlyer, BigDecimal underlyerMultiplier, OptionTypeEnum optionType, ProductTypeEnum productType,

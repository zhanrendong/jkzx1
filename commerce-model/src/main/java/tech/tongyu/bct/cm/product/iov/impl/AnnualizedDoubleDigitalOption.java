...
public class AnnualizedDoubleDigitalOption<U extends InstrumentOfValue> implements InstrumentOfValue, OptionExerciseFeature,
        InitialSpotFeature, PremiumFeature, SettlementFeature, EffectiveDateFeature, DoubleDigitalFeature {

    public AnnualizedDoubleDigitalOption() {
    }

    public AnnualizedDoubleDigitalOption(U underlyer, OptionTypeEnum optionType, ProductTypeEnum productType,
                                         ...
                                         LocalTime expirationTime, UnitOfValue<BigDecimal> lowStrike, UnitOfValue<BigDecimal> highStrike,
                                         UnitOfValue<BigDecimal> lowPayment, UnitOfValue<BigDecimal> highPayment,
    ...
    public String instrumentId() {
        return String.format("DoubleDigital_%s_option_European_%s",
    ...
    public UnitOfValue<BigDecimal> lowPayment;
    ...
    public UnitOfValue<BigDecimal> highPayment;

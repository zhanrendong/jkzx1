...
import tech.tongyu.bct.workflow.process.func.action.trade.TradeReviewTaskAction;
...
@Component
public class CreditReviewTaskAction implements TaskAction {

    private RequestManager requestManager;

    @Autowired
    public CreditReviewTaskAction(RequestManager requestManager) {
        this.requestManager = requestManager;
    }

    private static Logger logger = LoggerFactory.getLogger(TradeReviewTaskAction.class);

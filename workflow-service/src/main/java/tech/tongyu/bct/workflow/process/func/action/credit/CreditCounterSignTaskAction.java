...
import tech.tongyu.bct.workflow.process.func.action.account.AccountCounterSignTaskAction;
 ...
 */
@Component
public class CreditCounterSignTaskAction implements TaskAction {

    private RequestManager requestManager;

    @Autowired
    public CreditCounterSignTaskAction(RequestManager requestManager) {
        this.requestManager = requestManager;
    }

    private static Logger logger = LoggerFactory.getLogger(AccountCounterSignTaskAction.class);

 ...
 */
@Component
public class FundReviewTaskAction implements TaskAction {

    private RequestManager requestManager;

    @Autowired
    public FundReviewTaskAction(RequestManager requestManager) {
        this.requestManager = requestManager;
    }

    private static Logger logger = LoggerFactory.getLogger(FundReviewTaskAction.class);
